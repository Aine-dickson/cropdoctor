    ...
    <div class="view">
        ...
        <div v-else class="page">
                ...
                <div class="disease-info">
                    ...
                    <div class="conf-row">
                        <div class="conf-track">
                            <div class="conf-fill" :style="{ width: detection.result.confidence + '%' }"></div>
                        </div>
            ...
            <div class="bridge-card">
                ...
                <p v-else-if="!hasAvailableProducts" class="empty-catalogue-msg">
                    We found matching medicines, but they are currently out of stock. Try Browse or Search for
                    alternatives.
                </p>
                <div class="product-list">
                    <div class="product-row" v-for="p in detection.result.products" :key="p.id"
                        ...
                        <button class="btn-add"
                            ...
                            {{ isMedicineInStock(p.id) ? (cart.inCart(p.id) ? '✓ Added' : '+ Add') : '×' }}
                        </button>
                ...
                <button v-if="cart.count > 0" class="btn-primary" @click="router.push('/cart')">
                    View cart · {{ cart.count }} item{{ cart.count > 1 ? 's' : '' }} — UGX {{
            ...
            <transition name="slide-down">
                <div v-if="showFeedback" class="feedback-form">
                    ...
                    <button class="btn-secondary" :disabled="!correction" @click="submitFeedback">Submit
                        correction</button>
...
<script setup>
    ...
    const hasAvailableProducts = computed(() =>
        (detection.result?.products ?? []).some((product) => product.inventoryCount > 0),
    )
