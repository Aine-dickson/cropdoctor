<template>
    <div class="view">
        ...
        <header class="home-topbar">
            ...
            <button class="account-btn" :class="{ 'logged-in': auth.isLoggedIn }" @click="router.push('/account')">
                ...
                <div class="entry-card primary" @click="router.push('/')">
                    <div class="entry-icon">
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                            ...
                            <path d="M10 7V5a2 2 0 014 0v2" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                        </svg>
                    </div>
                ...
                <div class="entry-card" @click="router.push('/describe')">
                    <div class="entry-icon">
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                            ...
                            <path d="M8 10h12M8 14h9M8 18h6" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                        </svg>
                    </div>
                ...
                <div class="entry-card" @click="router.push('/browse')">
                    <div class="entry-icon">
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                            ...
                            <rect x="15" y="15" width="10" height="10" rx="2" stroke="currentColor"
                                stroke-width="1.7" />
                        </svg>
                    </div>
