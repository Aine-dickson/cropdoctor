    ...
    <header class="topbar">
        <div class="topbar-left">
            ...
            <div v-else class="brand" @click="router.push('/')">
                <svg width="40" height="40" viewBox="275 93 130 150" xmlns="http://www.w3.org/2000/svg">
                    <!-- Glow -->
                    <polygon points="340,96 402,132 402,204 340,240 278,204 278,132" fill="none" stroke="#2d7a3a"
                        stroke-width="6" opacity="0.08" stroke-linejoin="round" />

                    <!-- Hex fill -->
                    <polygon points="340,104 396,137 396,203 340,236 284,203 284,137" fill="#1a4d24" />

                    <!-- Hex border -->
                    <polygon points="340,104 396,137 396,203 340,236 284,203 284,137" fill="none" stroke="#2d7a3a"
                    ...
                    <!-- Leaf vein -->
                    <path d="M352,156 Q360,150 366,149" fill="none" stroke="#2d7a3a" stroke-width="1"
        ...
        <div class="topbar-right">
            ...
            <!-- Account -->
            <button v-else-if="showAccount" class="icon-btn account-btn" :class="{ 'logged-in': auth.isLoggedIn }"
                @click="router.push('/account')" aria-label="Account">
                <svg v-if="auth.isGuest" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <path d="M3 19c0-3.866 3.134-7 7-7s7 3.134 7 7" stroke="currentColor" stroke-width="1.7"
                        stroke-linecap="round" />
                </svg>
